...
$= \iint_D \frac{\partial Q}{\partial x} dxdy = \iint_D \Big( \frac{\partial Q}{\partial x}-\frac{\partial P}{\partial y} \Big) dxdy$
Vilket är det vi ville bevisa!
...
Alla ytor kan konstrueras genom att sätta ihop flera konvexa figurer utan lodräta/vågräta linjer samt lodräta/vågräta rektanglar.
> Footnote
